...
**1.3 信息流 ASCII**
```
News Text → BoW/Entropy Filter → Daily ES(t)
                                      ↓
Market (P, V, RV) ← [Multi-modal Conv GP Kernel] → GLRT Statistic Λ
                                      ↓
                              Causal Graph (X→Y / Y→X / Bidirectional)
```
