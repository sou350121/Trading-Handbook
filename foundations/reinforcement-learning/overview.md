...
| [Reinforcement Learning for Exe](reinforcement-learning-for-execution-under-dynamic-fees-in-a-closed-loop-dex-simulator) | 🔧 | [arXiv](https://arxiv.org/abs/2607.10960) | 构建闭环DEX模拟器，用DQN在动态费率环境下优化交易执行，相比调优启发式策略显著降低实现缺口。 |
| [NeuralChaos](neuralchaos) | 🔧 | [arXiv](https://arxiv.org/abs/2607.14361) | 提出NeuralChaos神经算子，用有限布朗运动采样逼近可预测平方可积过程，理论证明最优逼近率 |
| [Elicit-to-Optimize Framework](elicit-to-optimize-framework) | 🔧 | IJOC [arXiv](https://arxiv.org/abs/2607.14373) | 提出噪声鲁棒的偏好推断与策略优化框架，用贝叶斯IRL从噪声决策中提取风险偏好，结合分位数PPO优 |
