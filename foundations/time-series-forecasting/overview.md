...
> **本 zone 現有**：21 篇（19 篇成解構頁，其餘為 registry）
...
| RWKV-TS | 🔧 | RWKV-TS | 提出线性复杂度RNN架构RWKV-TS，通过分块与WKV算子实现高效长序列建模，在预测/分类/检 |
| 端到端期权交易深度学习框架 | 🔧 | 端到端期权交易深度学习框架 | 牛津大学提出端到端深度学习框架，直接优化夏普比率生成期权交易信号，结合换手率正则化显著提升高成本 |
| HAR-VIX | 🔧 | HAR-VIX | 对比HAR与ML模型预测实现波动率，发现配置得当的HAR模型在准确性、经济效用及可解释性上普遍优 |
