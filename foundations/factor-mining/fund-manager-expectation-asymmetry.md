...
# 美联储 ｜ 有形之手：基金经理预期与A股非对称价 解構（美联储 ｜ 有形之手：基金经理预期与A股非对称价格效应）
...
**信息流 ASCII 圖**：
```
季報文本 → 詞典映射(-1~1) → 增長預期指標
       ↓
主動基金調倉(股權份額/BETA/行業/SOE) → 交易行為驗證
       ↓
HGE(加權平均預期) → 非對稱價格衝擊(僅負向顯著)
       ↓
TCE(交易方向一致預期) → 異常回報解釋力↑ → 價格信息含量提升
```
