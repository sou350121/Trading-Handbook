...
> **本 zone 現有**：62 篇（56 篇成解構頁，其餘為 registry）
...
| [经验贝叶斯(EB)](eb) | ⚡ | 经验贝叶斯(EB) | 美联储首席经济学家用经验贝叶斯法系统挖掘13.6万策略，校正数据挖掘偏差，发现会计因子与小盘股在 |
...
| [3万个因子，数据挖掘能超越同行审议的因子吗？](3) | 🔧 | — | 对比2.9万数据挖掘因子与同行评审因子，发现两者样本外预测能力相当，风险理论因子衰减更快，数据挖 |
...
| 像生成语言一样生成Alpha：基于语法引导学习的因子挖掘 | ❌ | — | 本文实为QuantML社群推广帖，未提供具体论文内容或方法细节，仅提及基于语法引导的因子挖掘概念 |
