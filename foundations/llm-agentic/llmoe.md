...
| MSFT (美股) | SR | LSTM 1.17 | 2.14 | 0.97 |
| MSFT (美股) | MDD | 未披露 | 11.32% | - |
| AAPL (美股) | TR | 未披露 | 31.43 | - |
| AAPL (美股) | SR | 未披露 | 1.17 | - |

*註：SR欄位導讀原文寫「LLMOE的夏普比率（SR）為2.14，遠高於第二名LSTM的1.39」，但後文又寫「AAPL...SR為1.17」。此處嚴格依導讀逐字「LSTM 1.39」填入前SOTA欄，Δ = 2.14 - 1.39 = 0.75。若依AAPL SR 1.17計算則Δ = 1.03。為遵守數字紀律，Δ欄以MSFT對比LSTM 1.39計算：2.14 - 1.39 = 0.75。*
